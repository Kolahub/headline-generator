...
OBJECT_PRONOUNS = ['Her', 'Him', 'Them','Me', 'Us', 'You', 'It' ]
POSSESSIVE_PRONOUNS = ['Her', 'His', 'Their', 'Whose', 'Mine', 'Ours']
PERSONAL_PRONOUNS = ['Hey', 'His', 'Their', 'I', 'You', 'It', 'We', 'They', 'Us', 'Them']
STATES = ['California', 'Texas', 'Florida', 'New York', 'Pennsylvania', 'Illinois', 'Ohio', 'Georgia',
        'North Carolina', 'Michigan', 'Oklahoma', 'New Mexico', 'Arizona', 'Washington', 'Hawaii', 'Nevada', 'Massachusetts',
        'Virginia', 'Georgia']
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent', 'Cat', 'Dog', 'Chicken', 'Robot', 'Vidoe Game', 'Avocado', 'Plastic Straw', 'Serial Killer', 'Telephone Psychic', 'Ryan Renolds', 'Terrorist', 'India']
PLACES = ['House', 'Attic', 'Bank Deposit Box', 'School', 'Basement', 'Workplace', 'Donut Shop', 'Apocalypse Bunker']
WHEN = ['Soon', 'This Year', 'Later Today', 'RIGHt NOW', 'Next Week', 'Last year']
...
def main () :
    ...
    website = random.choice(['website', 'blog', 'Google', 'Facebook', 'Tweeter', 'Instagram'])
